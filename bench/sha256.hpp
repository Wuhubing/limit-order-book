#ifndef BENCH_SHA256_HPP
#define BENCH_SHA256_HPP

// Minimal SHA-256 (FIPS 180-4) returning lowercase hex, used to fingerprint
// generated corpora so `gen`/`run` are reproducible and re-runnable.
